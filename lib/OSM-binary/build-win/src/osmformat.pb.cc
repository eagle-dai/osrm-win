...
void protobuf_AddDesc_osmformat_2eproto() {
  ::google::protobuf::::google::protobuf::GoogleOnceInit(&protobuf_AddDesc_osmformat_2eproto_once_,
...
void HeaderBlock::SharedCtor() {
  ...
  osmosis_replication_base_url_ = const_cast< ::std::string*>(&::google::protobuf::internal::kEmptyString);
...
void HeaderBlock::SharedDtor() {
  ...
  if (osmosis_replication_base_url_ != &::google::protobuf::internal::kEmptyString) {
