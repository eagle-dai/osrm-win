-- Begin of globals
--require("lib/access") -- OSRM_WIN change, fix osrm-extract crash on Windows
...
function node_function (node)
  ...
  local access = find_access_tag(node, access_tags_hierachy) -- OSRM_WIN change
...
function way_function (way)
  ...
  local access = find_access_tag(way, access_tags_hierachy) -- OSRM_WIN change
  if access_tag_blacklist[access] then
    return
  end
